...
/* ═══════════════════════════════════════════════
   DESKTOP HOVER FLOAT
   CSS keyframes do the organic floating.
   Mouse adds a gentle extra parallax tilt on top.
   ═══════════════════════════════════════════════ */
function initHoverFloat() {
  ...
  function tick() {
    ...
    document.querySelectorAll('.hd__fig').forEach(fig => {
      ...
      // Add mouse offset on top of CSS animation via additional transform
      // We use a wrapper trick: the CSS animation handles the float,
      // and we set a CSS custom property for the mouse offset
